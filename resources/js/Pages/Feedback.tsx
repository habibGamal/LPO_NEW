    ...
    return (
        <section className="bg-ov-white min-h-[91vh] flex  items-center">
            <div className="container lg:py-16 py-4 grid grid-rows-auto gap-4 text-center lg:text-align-inherit lg:grid-cols-2 items-center justify-center">
                <div>
                    <h2 className="text-3xl md:text-4xl lg:text-5xl mb-4 lg:mb-8  font-medium ">
                        {t("يهمنا جدا معرفة ", " We are very interested in your ")}
                        <span className="highlight-header">
                            {t("رأيك", "opinion ")}
                        </span>{" "}
                        {t(
                            "في برنامج تدريس البيانو",
                            "about the piano teaching program"
                        )}
                    </h2>
