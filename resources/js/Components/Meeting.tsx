...
export default function Meeting({
    ...
    const [fileList, setFileList] = useState<UploadFile[]>(
        meeting ? ImagesHandler.getPathsAsUploadFiles(meeting.assets) : []
    );
    ...
    const getErrors = () =>
        meeting ? errors?.[`${meeting.id}`] : errors?.["-1"];
            ...
            {/* <div className="rounded bg-gray-100 shadow-sm p-4"> */}
                ...
                >
                    ...
                    >
                        <Select placeholder="Select state">
                            ...
                            <Select.Option value="in_meeting">
                                In Meeting
                            </Select.Option>
                    ...
                    <Form.List name="videos" initialValue={meeting?.videos}>
                ...
                {meeting && (
                    <Popconfirm
                        ...
                        onConfirm={() =>
                            Inertia.delete(`/meetings/${meeting.id}`)
                        }
                        okText="Yes"
                        cancelText="No"
                    >
